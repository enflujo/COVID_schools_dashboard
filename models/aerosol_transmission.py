...
def avg_quanta_concentration(
    lenght_room, width_room, height_room, ventilation_out, exhalation_mask_eff, fraction_people_masks, duration_event_h
):
    """
    ...
    return (net_emmision_rate_val / TOTAL_FO_LOSS_RATE / room_volume) * (
        1 - (1 / TOTAL_FO_LOSS_RATE / duration_event_h) * (1 - np2.exp(-TOTAL_FO_LOSS_RATE * duration_event_h))
    )


def quanta_inhaled_per_person(
    lenght_room,
    width_room,
    height_room,
    ventilation_out,
    ...
    avg_quanta_concentration_val = avg_quanta_concentration(
        lenght_room,
        width_room,
        height_room,
        ventilation_out,
    ...
    return (
        avg_quanta_concentration_val
        * breathing_rate
        * duration_event_h
        * (1 - inhalation_mask_eff * fraction_people_masks)
    )
...
def infection_probability(
    ...
    quanta_inhaled_per_person_val = quanta_inhaled_per_person(
        lenght_room,
        width_room,
        height_room,
        ventilation_out,
