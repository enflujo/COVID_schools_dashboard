...
def load_results(type_res,n,work_occ,comm_occ,path=results_path):
    read_path = os.path.join(path,'{}_schoolcap_0.35_work_occ_{}_comm_occ_{}_{}.csv'.format(
        str(n),str(work_occ),str(comm_occ),type_res))
...
def create_heatmaps_total(df_response, figs_path):
    ...
    plt.savefig(os.path.join(figs_path, 'totalInfections_occupations_heatmap_n_{}.png'.format(5000)), 
...
def create_heatmaps_peaks(df_response, figs_path):
    ...
    plt.savefig(os.path.join(figs_path, 'peakInfections_occupations_heatmap_n_{}.png'.format(5000)), 
                        dpi=400, transparent = False, bbox_inches = 'tight', pad_inches = 0.1)
...
def create_heatmaps_deaths(df_response, figs_path):
    ...
    plt.savefig(os.path.join(figs_path, 'totalDeaths_occupations_heatmap_n_{}.png'.format(5000)), 
                        dpi=400, transparent = False, bbox_inches = 'tight', pad_inches = 0.1)
